...
if(T.length<11)
{
alert("Phone Number must contain 11 Numeric Values");
document.forms[0].elements[8].focus();
return false;  
}
...
if(T.indexOf("0")==-1)
{
alert("The Phone must contain the Number '0'");
document.forms[0].elements[8].focus();
return false;  
}
...
if(!pos1<1)
{
alert("Phone must start with Number '0'");
document.forms[0].elements[8].focus();
return false;  
}  
return true;
        ...
        <tr>
            <td bgColor="c6d3ce">
			  ...
			  <tr bgColor="dee7e7">
				...
				<tr bgColor="e7efef">
                  <td>Phone</td>
                  <td><b><input type="text" size="10" maxlength="11" name="Tel" value="<?php echo $tel; ?>" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"></b></td>
				</tr>				
				<tr bgColor="dee7e7">
                  <td>Acount Type</td>
