...
$sql = "SELECT COUNT(*) FROM cart WHERE cust_id = '$userid' AND product_id = '$productid' AND checkout = 'n'";
...
if($rows == 0)
{
	$insertSQL = "INSERT INTO cart (id, product_id, qty, cust_id, checkout, added, checkedon, trans) VALUES ('', '$productid', '$Qty', '$userid', 'n', '$today', '', $code)";
...
{
	$sql1 = "SELECT * FROM cart WHERE cust_id = '$userid' AND product_id = '$productid' AND checkout = 'n'";
	...
	$updateqty = "UPDATE cart SET id = '$cartid', product_id = '$productid', qty = '$actualqty', cust_id = '$userid', checkout = '$checkout', added = '$today', checkedon = '', trans = '$code' WHERE cust_id = '$userid' AND product_id = '$productid' AND checkout = 'n'";
