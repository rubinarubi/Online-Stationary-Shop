			...
			<div class="box-content-1">
				<div class="box-product-1" >
					<?php
						...
						$selectproducts = "SELECT * FROM cart , product, users WHERE cart.cust_id = $userid AND users.user_id = $userid AND cart.checkout = 'n' AND product.id = cart.product_id";
								...
								<td bgColor="c6d3ce">
								  ...
								  <tr bgColor="dee7e7">
									...
									<tr bgColor="e7efef">
									  ...
									  <td><b><input type="text" size="10" maxlength="11" name="Tel" value="<?php echo $tel; ?>" disabled="TRUE" /></b></td>
									</tr>				
									</table>
								</td>
							</tr>
